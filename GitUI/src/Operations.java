...
public class Operations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Let's get committed!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String status = "";
        try{
            ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "cd "+Helper.repo+" && git status");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        String branch = JOptionPane.showInputDialog(this, "Input branch");
        try{
            ProcessBuilder builder = new ProcessBuilder("cmd.exe", "/c", "cd "+Helper.repo+" && git pull "+remote+" "+branch);
            builder.redirectErrorStream(true);
            Process p = builder.start();
            BufferedReader r = new BufferedReader(new InputStreamReader(p.getInputStream()));
            while(true){
